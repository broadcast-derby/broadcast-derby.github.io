...
export const FORMULAS: Formula[] = [
  ...
  { name: '馬連', description: '一着と二着の組み合わせを当てる', racehorseCount: 2, isCombination: true, keyword: 'ur' },
  { name: '馬単', description: '一着と二着の着順を当てる', racehorseCount: 2, isCombination: false, keyword: 'ut' },
